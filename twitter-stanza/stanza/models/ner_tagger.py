...
def evaluate(args):
    ...
    # model_file = "../../stanza_resources/en/ner/conll03.pt"

    # model_file = "saved_models/ner/en_tweet_nertagger_100d.pt"
    loaded_args, trainer, vocab = load_model(args, model_file)
    print("Loaded file %s"%model_file)
    # load data
    logger.info("Loading data with batch size {}...".format(args['batch_size']))
